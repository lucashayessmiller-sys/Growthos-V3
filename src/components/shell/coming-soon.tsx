...
const roadmapCopy: Record<string, string[]> = {
  ...
  "video-studio": ["Script-to-video generation for short-form", "Auto-captioning and brand outro", "Multi-aspect-ratio export"],
  "website-builder": ["AI-drafted landing pages from a single prompt", "Built-in CRO experimentation", "One-click publish to custom domain"],
  ...
  "automation": ["Visual, node-based workflow builder", "Trigger library across all 15 modules", "Version history and safe rollbacks"],
